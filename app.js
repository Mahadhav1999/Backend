...
mongoose
  ...
  .then(() => {
    console.log("Connection established to MongoDB!".bgYellow.white);
  })
  .catch((err) => {
    console.error("Error connecting to Mongo".bgRed.underline.white, err);
  });
...
app.listen(PORT, "localhost", () => {
  console.log(`server is started on ${PORT}`.cyan.underline.bold);
});
